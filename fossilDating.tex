...
We anticipate that this approach will have diverse applications including estimating dates for fossils that are temporally unconstrained, testing the ``morphological clock'', and as part of evaluating model assumptions when controversial phylogenetic hypotheses are obtained based on combined divergence dating analyses.
}
