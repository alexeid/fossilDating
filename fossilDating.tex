...
Overall the results from the M1 and M8 models were strikingly concordant. Figure \ref{fig:compareM1M8} shows three regressions between the two models: (a) Regression of estimated phylogenetic age of Model 1 against Model 8, (b) Regression of posterior probability of palaeontological range of Model 1 against Model 8, (c) Regression of Bayes factor (BF) for palaeontological range of Model 1 against Model 8.
...
Comparison of Model 1 against Model 8. (a) Regression of estimated phylogenetic age of Model 1 against Model 8, (b) Regression of error in estimated phylogenetic age of Model 1 against Model 8, (c) Regression of posterior probability of palaeontological range of Model 1 against Model 8, (c) Regression of Bayes factor (BF) for palaeontological range of Model 1 against Model 8.}
\end{figure}
