...
The fossil ages ranged from 4.5 to 61.3 Myr.
...
For the canid analysis we used a more standard parametrisation: origin $T$ with Uniform(0,120) prior, diversification rate $d$ with LogNormal(-3.5, 1.5), turnover and sampling proportion with Uniform(0,1) priors.
